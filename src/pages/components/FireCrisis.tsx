...
const questions: Question[] = [
  {
    id: 1,
    question:
      'اینجا اتاق سرور یه سازمان حدوداً ۱۰۰۰ نفره‌ست که تمام داده‌های شرکت رو پردازش می‌کرد. فکر می‌کنی حالا با از دست‌رفتن این رک‌ها، حدوداً روزی چقدر خسارت می‌بینن؟',
    options: [
      { text: 'بین ۱۰ تا ۵۰ میلیون تومان', isCorrect: false },
      { text: 'بین ۵۰ تا ۱۰۰ میلیون تومان', isCorrect: false },
      { text: 'بین ۱۰۰ تا ۲۰۰ میلیون تومان', isCorrect: false },
      { text: 'بیشتر از ۳۰۰ میلیون تومان', isCorrect: true },
    ],
  ...
  },
{
  id: 2,
  question:
    'فرض کن این سازمان از تمام داده‌ها یه نسخهٔ پشتیبان داشته باشه. به‌نظرت چقدر طول می‌کشه تا دوباره عملیاتش به حالت عادی برگرده؟',
  options: [
    { text: 'حدوداً ۲۴ ساعت', isCorrect: false },
    { text: 'حدوداً ۷۲ ساعت', isCorrect: false },
    { text: 'حدوداً ۲ هفته', isCorrect: true },
    { text: 'حدوداً ۱ هفته', isCorrect: false },
  ],
  correctFeedback:
    'درسته. حداقل ۲ هفته کاری زمان می‌بره تا سرویس‌ها دوباره UP & RUNNING بشن.',
  incorrectFeedback: 'نه، بیا دوباره تلاش کنیم.',
},
{
  id: 3,
  question:
    'به‌نظرت این شرکت از قبل باید چیکار می‌کرد تا بتونه حتی با وجود این آتش‌سوزی، در لحظه به کسب‌وکارش ادامه بده؟',
  options: [
    ...
    { text: 'داده‌ها رو روی هاردهای سازمانی ذخیره می‌کرد', isCorrect: false },
  ],
  correctFeedback:
    'درسته. فقط با داشتن یه زیرساختِ ثانویه‌ست که سرویس‌ها همون لحظه دوباره بالا میان.',
  incorrectFeedback: 'نه، بیا دوباره تلاش کنیم.',
}
];
