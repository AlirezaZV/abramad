...
interface LandingPageProps {
  onFormSubmit: (data: { firstName: string; lastName: string; phone: string; email: string }) => void;
}
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-between">
        ...
        >
          ...
          >
            همیشه فکر می‌کنیم حادثه برای بقیه‌ست...<br/> ولی حقیقت
            تلخ اینه که ممکنه قربانی بعدی حوادث ما باشیم!<br/> پس بیا
            ببینم چقدر برای روزهای بحرانی آماده‌ای.
          </motion.p>
